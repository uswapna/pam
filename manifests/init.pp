...
class pam (
  ...
  if $facts['os']['family'] == 'RedHat' and !($facts['os']['release']['major'] in ['6','7','8','9']) {
    fail("osfamily RedHat's os.release.major is <${::facts['os']['release']['major']}> and must be 6, 7, 8 or 9")
